...
unsafe extern "C" fn armthumb_code(
    ...
    size = size.wrapping_sub(4 as size_t);
    let mut i: size_t = 0;
    i = 0 as size_t;
    while i <= size {
        if *buffer.offset(i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
            & 0xf8 as ::core::ffi::c_int
            == 0xf0 as ::core::ffi::c_int
            && *buffer.offset(i.wrapping_add(3 as size_t) as isize) as ::core::ffi::c_int
                & 0xf8 as ::core::ffi::c_int
                == 0xf8 as ::core::ffi::c_int
        {
            let mut src: uint32_t =
                (*buffer.offset(i.wrapping_add(1 as size_t) as isize) as uint32_t & 7 as uint32_t)
            ...
            dest >>= 1 as ::core::ffi::c_int;
            *buffer.offset(i.wrapping_add(1 as size_t) as isize) =
                (0xf0 as uint32_t | dest >> 19 as ::core::ffi::c_int & 0x7 as uint32_t) as uint8_t;
            *buffer.offset(i.wrapping_add(0 as size_t) as isize) =
                (dest >> 11 as ::core::ffi::c_int) as uint8_t;
            *buffer.offset(i.wrapping_add(3 as size_t) as isize) =
                (0xf8 as uint32_t | dest >> 8 as ::core::ffi::c_int & 0x7 as uint32_t) as uint8_t;
            *buffer.offset(i.wrapping_add(2 as size_t) as isize) = dest as uint8_t;
...
unsafe extern "C" fn armthumb_coder_init(
...
pub unsafe extern "C" fn lzma_simple_armthumb_encoder_init(
    ...
    return armthumb_coder_init(next, allocator, filters, true_0 != 0);
}
#[no_mangle]
pub unsafe extern "C" fn lzma_simple_armthumb_decoder_init(
    ...
    return armthumb_coder_init(next, allocator, filters, false_0 != 0);
}
