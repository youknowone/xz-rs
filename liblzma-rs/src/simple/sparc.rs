...
unsafe extern "C" fn sparc_code(
    ...
    i = 0 as size_t;
    while i < size {
        if *buffer.offset(i as isize) as ::core::ffi::c_int == 0x40 as ::core::ffi::c_int
            && *buffer.offset(i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
                & 0xc0 as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
            || *buffer.offset(i as isize) as ::core::ffi::c_int == 0x7f as ::core::ffi::c_int
                && *buffer.offset(i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
                    & 0xc0 as ::core::ffi::c_int
                    == 0xc0 as ::core::ffi::c_int
        {
            let mut src: uint32_t = (*buffer.offset(i.wrapping_add(0 as size_t) as isize)
                as uint32_t)
                << 24 as ::core::ffi::c_int
                | (*buffer.offset(i.wrapping_add(1 as size_t) as isize) as uint32_t)
                    << 16 as ::core::ffi::c_int
                | (*buffer.offset(i.wrapping_add(2 as size_t) as isize) as uint32_t)
                    << 8 as ::core::ffi::c_int
                | *buffer.offset(i.wrapping_add(3 as size_t) as isize) as uint32_t;
            ...
            dest = (0 as uint32_t).wrapping_sub(dest >> 22 as ::core::ffi::c_int & 1 as uint32_t)
                << 22 as ::core::ffi::c_int
                & 0x3fffffff as uint32_t
                | dest & 0x3fffff as uint32_t
                | 0x40000000 as uint32_t;
            *buffer.offset(i.wrapping_add(0 as size_t) as isize) =
                (dest >> 24 as ::core::ffi::c_int) as uint8_t;
            ...
            *buffer.offset(i.wrapping_add(3 as size_t) as isize) = dest as uint8_t;
        }
...
pub unsafe extern "C" fn lzma_simple_sparc_encoder_init(
    ...
    return sparc_coder_init(next, allocator, filters, true_0 != 0);
}
#[no_mangle]
pub unsafe extern "C" fn lzma_simple_sparc_decoder_init(
    ...
    return sparc_coder_init(next, allocator, filters, false_0 != 0);
}
