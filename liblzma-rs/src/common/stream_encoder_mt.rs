...
extern "C" {
    ...
    fn lzma_mt_block_size(filters: *const lzma_filter) -> uint64_t;
    ...
    fn lzma_block_buffer_bound64(uncompressed_size: uint64_t) -> uint64_t;
    fn lzma_index_encoder_init(
        next: *mut lzma_next_coder,
        allocator: *const lzma_allocator,
        i: *const lzma_index,
    ) -> lzma_ret;
    fn lzma_outq_memusage(buf_size_max: uint64_t, threads: uint32_t) -> uint64_t;
    fn lzma_outq_init(
        outq: *mut lzma_outq,
        allocator: *const lzma_allocator,
        threads: uint32_t,
...
pub const BLOCK_SIZE_MAX: ::core::ffi::c_ulonglong =
    UINT64_MAX.wrapping_div(LZMA_THREADS_MAX as ::core::ffi::c_ulonglong);
unsafe extern "C" fn worker_error(mut thr: *mut worker_thread, mut ret: lzma_ret) {
    let mut mythread_i_207: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
    ...
    {
        let mut mythread_j_207: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        while mythread_j_207 == 0 {
            if (*(*thr).coder).thread_error as ::core::ffi::c_uint
                == LZMA_OK as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                (*(*thr).coder).thread_error = ret;
            }
            mythread_cond_signal(&raw mut (*(*thr).coder).cond);
            mythread_j_207 = 1 as ::core::ffi::c_uint;
        }
        mythread_i_207 = 1 as ::core::ffi::c_uint;
    }
}
unsafe extern "C" fn worker_encode(
    ...
    (*thr).block_options = lzma_block {
        ...
        reserved_ptr3: ::core::ptr::null_mut::<::core::ffi::c_void>(),
        reserved_int1: 0,
        reserved_int2: 0,
        reserved_int3: 0,
        reserved_int4: 0,
    ...
    let mut in_size: size_t = 0 as size_t;
    *out_pos = (*thr).block_options.header_size as size_t;
    let out_size: size_t = (*(*thr).outbuf).allocated;
    loop {
        let mut mythread_i_258: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_258: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_258 == 0 {
                (*thr).progress_in = in_pos as uint64_t;
                (*thr).progress_out = *out_pos as uint64_t;
                while in_size == (*thr).in_size
                    && (*thr).state as ::core::ffi::c_uint
                        == THR_RUN as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    mythread_cond_wait(&raw mut (*thr).cond, &raw mut (*thr).mutex);
                }
                state = (*thr).state;
                in_size = (*thr).in_size;
                mythread_j_258 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_258 = 1 as ::core::ffi::c_uint;
        }
        if state as ::core::ffi::c_uint >= THR_STOP as ::core::ffi::c_int as ::core::ffi::c_uint {
            return state;
        }
        let mut action: lzma_action = (if state as ::core::ffi::c_uint
            == THR_FINISH as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            LZMA_FINISH as ::core::ffi::c_int
        } else {
            LZMA_RUN as ::core::ffi::c_int
        }) as lzma_action;
    ...
    match ret as ::core::ffi::c_uint {
        ...
        0 => {
            let mut mythread_i_321: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            ...
            {
                let mut mythread_j_321: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
                while mythread_j_321 == 0 {
                    while (*thr).state as ::core::ffi::c_uint
                        == THR_RUN as ::core::ffi::c_int as ::core::ffi::c_uint
                    {
                        mythread_cond_wait(&raw mut (*thr).cond, &raw mut (*thr).mutex);
                    }
                    state = (*thr).state;
                    in_size = (*thr).in_size;
                    mythread_j_321 = 1 as ::core::ffi::c_uint;
                }
                mythread_i_321 = 1 as ::core::ffi::c_uint;
            }
            if state as ::core::ffi::c_uint >= THR_STOP as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                return state;
...
unsafe extern "C" fn worker_start(
    ...
    loop {
        let mut mythread_i_370: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_370: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_370 == 0 {
                loop {
                    if (*thr).state as ::core::ffi::c_uint
                        == THR_STOP as ::core::ffi::c_int as ::core::ffi::c_uint
                    {
                        (*thr).state = THR_IDLE;
                ...
                mythread_j_370 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_370 = 1 as ::core::ffi::c_uint;
        }
        let mut out_pos: size_t = 0 as size_t;
        if state as ::core::ffi::c_uint <= THR_FINISH as ::core::ffi::c_int as ::core::ffi::c_uint {
            state = worker_encode(thr, &raw mut out_pos, state);
        }
        if state as ::core::ffi::c_uint == THR_EXIT as ::core::ffi::c_int as ::core::ffi::c_uint {
            break;
        }
        let mut mythread_i_401: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_401: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_401 == 0 {
                ...
                mythread_j_401 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_401 = 1 as ::core::ffi::c_uint;
        }
        let mut mythread_i_408: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_408: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_408 == 0 {
                ...
                (*(*thr).coder).progress_in = (*(*thr).coder)
                    .progress_in
                    .wrapping_add((*(*thr).outbuf).uncompressed_size as uint64_t);
                (*(*thr).coder).progress_out = (*(*thr).coder)
                    .progress_out
                    .wrapping_add(out_pos as uint64_t);
                (*thr).progress_in = 0 as uint64_t;
                (*thr).progress_out = 0 as uint64_t;
                (*thr).next = (*(*thr).coder).threads_free;
                (*(*thr).coder).threads_free = thr;
                mythread_cond_signal(&raw mut (*(*thr).coder).cond);
                mythread_j_408 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_408 = 1 as ::core::ffi::c_uint;
        }
    }
    lzma_filters_free(
...
unsafe extern "C" fn threads_stop(mut coder: *mut lzma_stream_coder, mut wait_for_threads: bool) {
    ...
    while i < (*coder).threads_initialized {
        let mut mythread_i_449: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_449: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_449 == 0 {
                ...
                mythread_j_449 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_449 = 1 as ::core::ffi::c_uint;
        }
        i = i.wrapping_add(1);
    }
    if !wait_for_threads {
    ...
    while i_0 < (*coder).threads_initialized {
        let mut mythread_i_460: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_460: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_460 == 0 {
                while (*(*coder).threads.offset(i_0 as isize)).state as ::core::ffi::c_uint
                    != THR_IDLE as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    mythread_cond_wait(
                ...
                mythread_j_460 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_460 = 1 as ::core::ffi::c_uint;
        }
...
unsafe extern "C" fn threads_end(
    ...
    let mut i: uint32_t = 0 as uint32_t;
    while i < (*coder).threads_initialized {
        let mut mythread_i_477: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_477: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_477 == 0 {
                (*(*coder).threads.offset(i as isize)).state = THR_EXIT;
                mythread_cond_signal(&raw mut (*(*coder).threads.offset(i as isize)).cond);
                mythread_j_477 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_477 = 1 as ::core::ffi::c_uint;
        }
        i = i.wrapping_add(1);
    }
    let mut i_0: uint32_t = 0 as uint32_t;
...
unsafe extern "C" fn initialize_new_thread(
    ...
    (*thr).in_0 = lzma_alloc((*coder).block_size, allocator) as *mut uint8_t;
    if (*thr).in_0.is_null() {
    ...
    if !(mythread_mutex_init(&raw mut (*thr).mutex) != 0) {
        if !(mythread_cond_init(&raw mut (*thr).cond) != 0) {
            ...
            (*thr).filters[0 as ::core::ffi::c_int as usize].id = LZMA_VLI_UNKNOWN as lzma_vli;
            if mythread_create(
    ...
    lzma_free((*thr).in_0 as *mut ::core::ffi::c_void, allocator);
    return LZMA_MEM_ERROR;
}
unsafe extern "C" fn get_thread(
    ...
    if (*coder).filters_cache[0 as ::core::ffi::c_int as usize].id == LZMA_VLI_UNKNOWN as lzma_vli {
    ...
    let mut mythread_i_560: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
    ...
    {
        let mut mythread_j_560: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        while mythread_j_560 == 0 {
            if !(*coder).threads_free.is_null() {
                (*coder).thr = (*coder).threads_free;
                (*coder).threads_free = (*(*coder).threads_free).next;
            }
            mythread_j_560 = 1 as ::core::ffi::c_uint;
        }
        mythread_i_560 = 1 as ::core::ffi::c_uint;
    }
    ...
    let mut mythread_i_578: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
    ...
    {
        let mut mythread_j_578: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        while mythread_j_578 == 0 {
            ...
            memcpy(
                &raw mut (*(*coder).thr).filters as *mut lzma_filter as *mut ::core::ffi::c_void,
                &raw mut (*coder).filters_cache as *mut lzma_filter as *const ::core::ffi::c_void,
                ::core::mem::size_of::<[lzma_filter; 5]>() as size_t,
            );
            (*coder).filters_cache[0 as ::core::ffi::c_int as usize].id =
                LZMA_VLI_UNKNOWN as lzma_vli;
            mythread_cond_signal(&raw mut (*(*coder).thr).cond);
            mythread_j_578 = 1 as ::core::ffi::c_uint;
        }
        mythread_i_578 = 1 as ::core::ffi::c_uint;
    }
    return LZMA_OK;
}
unsafe extern "C" fn stream_encode_in(
                ...
                != LZMA_RUN as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        ...
        let mut mythread_i_628: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        ...
        {
            let mut mythread_j_628: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            while mythread_j_628 == 0 {
                if (*(*coder).thr).state as ::core::ffi::c_uint
                    == THR_IDLE as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                ...
                mythread_j_628 = 1 as ::core::ffi::c_uint;
            }
            mythread_i_628 = 1 as ::core::ffi::c_uint;
        }
        if block_error {
            let mut ret_0: lzma_ret = LZMA_OK;
            let mut mythread_i_649: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
            ...
            {
                let mut mythread_j_649: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
                while mythread_j_649 == 0 {
                    ret_0 = (*coder).thread_error;
                    mythread_j_649 = 1 as ::core::ffi::c_uint;
                }
                mythread_i_649 = 1 as ::core::ffi::c_uint;
            }
            return ret_0;
        }
        if finish {
...
unsafe extern "C" fn wait_for_work(
    ...
    {
        let mut mythread_j_689: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        while mythread_j_689 == 0 {
            while (!has_input
                ...
                && (*coder).thread_error as ::core::ffi::c_uint
                    == LZMA_OK as ::core::ffi::c_int as ::core::ffi::c_uint
                && !timed_out
            {
            ...
            mythread_j_689 = 1 as ::core::ffi::c_uint;
        }
        mythread_i_689 = 1 as ::core::ffi::c_uint;
    }
    return timed_out;
}
unsafe extern "C" fn stream_encode_mt(
    ...
    's_270: {
        ...
        match (*coder).sequence as ::core::ffi::c_uint {
            0 => {
                lzma_bufcpy(
                    &raw mut (*coder).header as *mut uint8_t,
                ...
                if (*coder).header_pos < ::core::mem::size_of::<[uint8_t; 12]>() as usize {
                    return LZMA_OK;
                }
        ...
        match current_block_53 {
            18046538441878631153 => {
                ...
                loop {
                    let mut mythread_i_747: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
                    ...
                    {
                        let mut mythread_j_747: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
                        while mythread_j_747 == 0 {
                            ...
                            mythread_j_747 = 1 as ::core::ffi::c_uint;
                        }
                        mythread_i_747 = 1 as ::core::ffi::c_uint;
                    }
                    if ret as ::core::ffi::c_uint
                    ...
                    if *in_pos == in_size {
                        ...
                        if lzma_outq_is_empty(&raw mut (*coder).outq) {
                            ...
                            if action as ::core::ffi::c_uint
                                == LZMA_FULL_FLUSH as ::core::ffi::c_int as ::core::ffi::c_uint
                            {
                                return LZMA_STREAM_END;
                            }
                        }
        ...
        return (if (*coder).header_pos < ::core::mem::size_of::<[uint8_t; 12]>() as usize {
...
unsafe extern "C" fn stream_encoder_mt_update(
    ...
    let mut coder: *mut lzma_stream_coder = coder_ptr as *mut lzma_stream_coder;
    if (*coder).sequence as ::core::ffi::c_uint
    ...
    if lzma_raw_encoder_memusage(filters) == UINT64_MAX as uint64_t {
    ...
    memcpy(
        &raw mut (*coder).filters as *mut lzma_filter as *mut ::core::ffi::c_void,
        &raw mut temp as *mut lzma_filter as *const ::core::ffi::c_void,
        ::core::mem::size_of::<[lzma_filter; 5]>() as size_t,
    );
    return LZMA_OK;
}
unsafe extern "C" fn get_options(
    ...
    mut block_size: *mut uint64_t,
    mut outbuf_size_max: *mut uint64_t,
) -> lzma_ret {
    if options.is_null() {
        return LZMA_PROG_ERROR;
    }
    if (*options).flags != 0 as uint32_t
        || (*options).threads == 0 as uint32_t
        || (*options).threads > LZMA_THREADS_MAX as uint32_t
    {
        return LZMA_OPTIONS_ERROR;
    }
    ...
    if (*options).block_size > 0 as uint64_t {
        *block_size = (*options).block_size;
    } else {
        *block_size = lzma_mt_block_size(*filters);
    }
    if *block_size > BLOCK_SIZE_MAX as uint64_t || *block_size == UINT64_MAX as uint64_t {
        return LZMA_OPTIONS_ERROR;
    }
    *outbuf_size_max = lzma_block_buffer_bound64(*block_size);
    if *outbuf_size_max == 0 as uint64_t {
        return LZMA_MEM_ERROR;
    }
    return LZMA_OK;
}
unsafe extern "C" fn get_progress(
    ...
    let mut coder: *mut lzma_stream_coder = coder_ptr as *mut lzma_stream_coder;
    let mut mythread_i_1010: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
    ...
    {
        let mut mythread_j_1010: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        while mythread_j_1010 == 0 {
            *progress_in = (*coder).progress_in;
            *progress_out = (*coder).progress_out;
            let mut i: size_t = 0 as size_t;
            while i < (*coder).threads_initialized as size_t {
                let mut mythread_i_1015: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
                ...
                {
                    let mut mythread_j_1015: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
                    while mythread_j_1015 == 0 {
                        ...
                        *progress_out = (*progress_out)
                        ...
                        mythread_j_1015 = 1 as ::core::ffi::c_uint;
                    }
                    mythread_i_1015 = 1 as ::core::ffi::c_uint;
                }
                i = i.wrapping_add(1);
            }
            mythread_j_1010 = 1 as ::core::ffi::c_uint;
        }
        mythread_i_1010 = 1 as ::core::ffi::c_uint;
    }
}
unsafe extern "C" fn stream_encoder_mt_init(
    ...
    let mut block_size: uint64_t = 0;
    let mut outbuf_size_max: uint64_t = 0;
    ...
    if coder.is_null() {
        ...
        (*coder).filters_cache[0 as ::core::ffi::c_int as usize].id = LZMA_VLI_UNKNOWN as lzma_vli;
        ...
        (*coder).threads_max = 0 as uint32_t;
    ...
    (*coder).stream_flags.version = 0 as uint32_t;
    ...
    (*coder).progress_out = LZMA_STREAM_HEADER_SIZE as uint64_t;
    return LZMA_OK;
}
#[no_mangle]
pub unsafe extern "C" fn lzma_stream_encoder_mt(
    ...
    (*(*strm).internal).supported_actions[LZMA_FULL_FLUSH as ::core::ffi::c_int as usize] =
        true_0 != 0;
    (*(*strm).internal).supported_actions[LZMA_FULL_BARRIER as ::core::ffi::c_int as usize] =
        true_0 != 0;
    (*(*strm).internal).supported_actions[LZMA_FINISH as ::core::ffi::c_int as usize] = true_0 != 0;
    return LZMA_OK;
}
#[no_mangle]
pub unsafe extern "C" fn lzma_stream_encoder_mt_memusage(mut options: *const lzma_mt) -> uint64_t {
    let mut easy: lzma_options_easy = lzma_options_easy {
        filters: [lzma_filter {
            id: 0,
            options: ::core::ptr::null_mut::<::core::ffi::c_void>(),
    ...
    let inbuf_memusage: uint64_t = ((*options).threads as uint64_t).wrapping_mul(block_size);
    let mut filters_memusage: uint64_t = lzma_raw_encoder_memusage(filters);
    if filters_memusage == UINT64_MAX as uint64_t {
        return UINT64_MAX as uint64_t;
    }
    filters_memusage = filters_memusage.wrapping_mul((*options).threads as uint64_t);
    let outq_memusage: uint64_t =
        lzma_outq_memusage(outbuf_size_max, (*options).threads) as uint64_t;
    if outq_memusage == UINT64_MAX as uint64_t {
        return UINT64_MAX as uint64_t;
    }
    let mut total_memusage: uint64_t = (LZMA_MEMUSAGE_BASE as uint64_t)
        .wrapping_add(::core::mem::size_of::<lzma_stream_coder>() as uint64_t)
        .wrapping_add(
            ((*options).threads as usize)
                .wrapping_mul(::core::mem::size_of::<worker_thread>() as usize)
                as uint64_t,
        );
    if (UINT64_MAX as uint64_t).wrapping_sub(total_memusage) < inbuf_memusage {
        return UINT64_MAX as uint64_t;
    }
    total_memusage = total_memusage.wrapping_add(inbuf_memusage);
    if (UINT64_MAX as uint64_t).wrapping_sub(total_memusage) < filters_memusage {
        return UINT64_MAX as uint64_t;
    }
    total_memusage = total_memusage.wrapping_add(filters_memusage);
    if (UINT64_MAX as uint64_t).wrapping_sub(total_memusage) < outq_memusage {
        return UINT64_MAX as uint64_t;
    }
