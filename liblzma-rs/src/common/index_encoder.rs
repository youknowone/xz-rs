...
extern "C" {
    ...
    fn lzma_index_padding_size(i: *const lzma_index) -> uint32_t;
}
...
unsafe extern "C" fn index_encode(
    ...
    while *out_pos < out_size {
        match (*coder).sequence as ::core::ffi::c_uint {
            0 => {
                *out.offset(*out_pos as isize) = INDEX_INDICATOR as uint8_t;
        ...
        match current_block {
            10048703153582371463 => {
                let size: lzma_vli = if (*coder).sequence as ::core::ffi::c_uint
            ...
            _ => {
                loop {
                    ...
                    *out.offset(*out_pos as isize) =
                        ((*coder).crc32 >> (*coder).pos.wrapping_mul(8 as size_t)
...
pub unsafe extern "C" fn lzma_index_buffer_encode(
    ...
    let mut coder: lzma_index_coder = lzma_index_coder {
        ...
        iter: lzma_index_iter {
            stream: C2RustUnnamed_2 {
                ...
                reserved_ptr1: ::core::ptr::null::<::core::ffi::c_void>(),
                reserved_ptr2: ::core::ptr::null::<::core::ffi::c_void>(),
                reserved_ptr3: ::core::ptr::null::<::core::ffi::c_void>(),
                number: 0,
                block_count: 0,
                compressed_offset: 0,
            ...
            block: C2RustUnnamed_1 {
                ...
                reserved_ptr2: ::core::ptr::null::<::core::ffi::c_void>(),
                reserved_ptr3: ::core::ptr::null::<::core::ffi::c_void>(),
                reserved_ptr4: ::core::ptr::null::<::core::ffi::c_void>(),
            },
            internal: [C2RustUnnamed_0 {
                p: ::core::ptr::null::<::core::ffi::c_void>(),
            }; 6],
        },
        pos: 0,
        crc32: 0,
    ...
    let mut ret: lzma_ret = index_encode(
        &raw mut coder as *mut ::core::ffi::c_void,
