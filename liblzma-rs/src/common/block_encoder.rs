...
unsafe extern "C" fn block_encode(
    ...
    's_142: {
        ...
        match current_block_34 {
            6470892831169497455 => {
                while (*coder).compressed_size & 3 as lzma_vli != 0 {
                    ...
                    *out.offset(*out_pos as isize) = 0 as uint8_t;
        ...
        lzma_bufcpy(
            &raw mut (*coder).check.buffer.u8_0 as *mut uint8_t,
            &raw mut (*coder).pos,
            check_size,
            out,
            out_pos,
        ...
        memcpy(
            &raw mut (*(*coder).block).raw_check as *mut uint8_t as *mut ::core::ffi::c_void,
